  ...
  return (
    <div style={styles.flexContainer}>
      <Item
        title="Receita 1"
        subtitle="Turma 1"
        description="Descrição da instrução 1"
      />
      <Item
        title="Receita 2"
        subtitle="Turma 2"
        description="Descrição da instrução 2"
      />
      <Item
        title="Receita 3"
        subtitle="Turma 3"
        description="Descrição da instrução 3"
      />
      <Item
        title="Receita 4"
        subtitle="Turma 4"
        description="Descrição da instrução 4"
      />
      <Item
        title="Receita 5"
        subtitle="Turma 5"
        description="Descrição da instrução 5"
      />
      <Item
        title="Receita 6"
        subtitle="Turma 6"
        description="Descrição da instrução 6"
      />
      <Item
        title="Receita 7"
        subtitle="Turma 7"
        description="Descrição da instrução 7"
      />
    </div>
  );
};
